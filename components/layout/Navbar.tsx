      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          <Link href="/" className="flex items-center space-x-2">
            <span className="text-farm-green text-xl font-bold font-poppins">GreenField</span>
            <span className="text-farm-brown text-xl font-bold font-poppins">Market</span>
          </Link>
          
          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-6">
            <Link href="/" className="text-gray-700 hover:text-farm-green transition-colors">
              Home
            </Link>
            <Link href="/products" className="text-gray-700 hover:text-farm-green transition-colors">
              Products
            </Link>
            ...
            <CustomConnectButton />
            <Button asChild variant="default" size="sm" className="bg-farm-green hover:bg-farm-green-dark">
              <Link href="/wishlist">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 bg-white">
            <div className="flex flex-col space-y-4 py-3">
              ...
              <Button asChild variant="default" size="sm" className="bg-farm-green hover:bg-farm-green-dark w-full">
